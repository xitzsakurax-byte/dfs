...
export const vocab: VocabItem[] = [
  // === Curated professional B1-C1 vocabulary for TELC & Goethe exams ===
  // Focus: B1+ exam-relevant (workplace, Ausbildung, sustainability, communication) + strong mix of B2 academic/normal + C1 high-level.
  // No A1-A2 basics (no "der Bus", "die Milch", "das Haus", "der Hund", simple food/weather/family/transport).
  // All entries support real exam tasks: reports, emails, opinions, professional discussions.

  // Core professional B1 (exam staples)
  ...
  // Academic / high-level B2-C1 (for reports, analysis, C1 elements in B2 exams)
  ...
  // Strong normal B2 + professional communication (everyday but exam-level, not A1)
  ...
  { de: "sich auseinandersetzen mit", en: "to engage with / deal with", example: "Man muss sich kritisch mit den neuen Vorschriften auseinandersetzen.", topic: "Persönliche Entwicklung", cefr: "B2" },
  ...
  // Additional strong B1-C1 professional / exam words
...
// In the quiz, we further shuffle and generate options dynamically for true randomness and scalability.
